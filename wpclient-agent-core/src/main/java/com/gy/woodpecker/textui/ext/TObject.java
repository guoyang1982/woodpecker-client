package com.gy.woodpecker.textui.ext;

import com.google.gson.Gson;
import com.gy.woodpecker.textui.TComponent;
...
import static com.gy.woodpecker.tools.GaStringUtils.newString;
...
public class TObject implements TComponent {
    ...
    private final Boolean isUsingJson;

    public TObject(Object object, Integer expend, Boolean isUsingJson) {
        this.object = object;
        this.expend = expend;
        this.isUsingJson = isUsingJson;
    }
